...
export default function Page(){
    ...
    return(<div className="relative w-full h-auto">
        <div className="relative w-full h-160 flex items-center justify-center bg-[url('/productimg1.jpg')] before:absolute before:inset-0 before:bg-black/30 bg-cover bg-center shadow-lg shadow-black/10">
        ...
        <div className="relative w-full h-auto flex items-center justify-center">
            <div className="relative w-[95%] md:w-[90%] lg:w-[85%] border-x-2 border-red-600/60 mt-12 p-8 flex flex-row flex-wrap justify-center items-center">
