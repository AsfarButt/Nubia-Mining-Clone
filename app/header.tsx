...
export default function Header(){
    ...
    return(<div className="relative w-full h-16 bg-linear-to-r from-blue-900/90 to-blue-800/85 flex items-center justify-between px-2 md:px-4">
        ...
        <div className="relative w-[30%] min-w-80 h-full flex flex-row items-center justify-between">
            ...
            <><li className="text-blue-950/90 hover:text-white/90">Locations</li>
            <li className="text-blue-950/90 hover:text-white/90">History</li>
            <li className="text-blue-950/90 hover:text-white/90">ESG</li>
            <li className="text-blue-950/90 hover:text-white/90">Careers</li></>
            </div>
            </a>
            <div className="w-1 h-[85%] bg-white/60" ></div>
