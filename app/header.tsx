...
export default function Header({Selection}:{Selection: number}){
    ...
    return(<div className="sticky top-0 w-full h-15 sm:h-16 bg-black flex items-center justify-between px-2 md:px-4 before:absolute before:inset-0 before:bg-blue-900/60 before:brightness-95 z-20">
        ...
        <div className="relative w-[85%] md:w-[65%] lg:w-[45%] h-full flex flex-row items-center justify-between z-2">
            ...
            <li className="text-white/65 p-1 hover:text-white/75 hover:underline decoration-white/70">Assets</li>
            </>
            </div>
            </a>
