...
export default function Header({Selection}:{Selection: number}){
    ...
    return(<div className="sticky top-0 z-5 w-full h-15 sm:h-16 bg-black flex items-center justify-between px-2 md:px-4 before:absolute before:inset-0 before:bg-blue-900/60 before:brightness-100">
        ...
        <div className="relative w-[85%] md:w-[65%] lg:w-[45%] h-full flex flex-row items-center justify-between z-2">
            <a className={`relative w-full h-full list-none onstartheaderanimation1 text-gray-200/90 flex items-center text-[15px] sm:text-[16px] font-sans hover:text-yellow-500/85 justify-center sm:px-1 ${(Selection==1)? "text-yellow-500/85":"text-gray-200/90"}`} href="/Home">Home</a>
            <div className="w-1 h-[85%] bg-white/60" ></div>
            <a className={`relative w-full h-full list-none onstartheaderanimation2 text-gray-200/90 flex items-center text-[15px] sm:text-[16px] font-sans hover:text-yellow-500/85 justify-center sm:px-1 ${(Selection==2)? "text-yellow-500/85":"text-gray-200/90"} group`} href="/About">About us
            ...
            <div className="w-1 h-[85%] bg-white/60" ></div>
            <a className={`relative w-full h-full list-none onstartheaderanimation3 text-gray-200/90 flex items-center text-[15px] sm:text-[16px] font-sans hover:text-yellow-500/85 justify-center sm:px-1 ${(Selection==3)? "text-yellow-500/85":"text-gray-200/90"}`} href="/Products">Products</a>
            <div className="w-1 h-[85%] bg-white/60" ></div>
            <a className={`relative w-full h-full list-none onstartheaderanimation4 text-gray-200/90 flex items-center text-[15px] sm:text-[16px] font-sans hover:text-yellow-500/85 justify-center sm:px-1 ${(Selection==4)? "text-yellow-500/85":"text-gray-200/90"}`} href="/Services">Services</a>
            <div className="w-1 h-[85%] bg-white/60 hidden sm:block" ></div>
            <a className={`hidden relative w-full h-full list-none onstartheaderanimation5 text-gray-200/90 md:flex items-center text-[15px] sm:text-[16px] font-sans hover:text-yellow-500/85 justify-center sm:px-1 ${(Selection==5)? "text-yellow-500/85":"text-gray-200/90"}`} href="/ContactUs">Contact Us</a>
            <div className="w-1 h-[85%] bg-white/60 hidden sm:block" ></div>
        </div>
    </div>)
}