...
export default function Header(){
    ...
    return(<div className="sticky top-0 z-5 w-full h-18 bg-black flex items-center justify-between px-2 md:px-4 before:absolute before:inset-0 before:bg-linear-to-r before:from-blue-950/90 before:to-blue-900/85 overflow-hidden">
        <div className="relative w-auto h-full flex flex-row items-center justify-center gap-2 scale-80 sm:scale-100">
            ...
            <div className="relative w-30 sm:w-32 h-28 mt-2 bg-[url('/brandtext.png')] bg-center bg-cover"></div>
        </div>
